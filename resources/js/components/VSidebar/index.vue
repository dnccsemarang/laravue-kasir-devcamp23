                ...
                <div class="flex w-full sidebar-expanded:justify-between justify-end">
                    <Link :class="sidebarExpanded ?  'block' : 'hidden'" class="pl-2 transition-all duration-200" href="/">
                        <div class="flex justify-start w-full">
                            <img class="w-8 h-8 rounded-full" src="https://cdn.vectorstock.com/i/1000x1000/54/10/laravel-php-web-framework-logo-vector-41005410.webp" alt="Logo" />
                            <div class="ml-2 my-auto text-white font-bold text-lg">KASIR</div>
                        </div>
                    </Link>
